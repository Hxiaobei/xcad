...
namespace XCad.kit.PageBuilder.Core {
    public class DependencyManager : IDependencyManager {
        private class ControlUpdateStateData {
            ...
            internal ControlUpdateStateData(ISwApplication app, IBinding src, IBinding[] deps, IDependencyHandler handler) {
                m_App = app;
                m_Source = src;
                m_Dependencies = deps;
                m_Handler = handler;
        ...
        private class MetadataUpdateStateData {
            ...
            internal MetadataUpdateStateData(ISwApplication app, IControl ctrl, IMetadata[] deps, IMetadataDependencyHandler handler) {
                m_App = app;
                m_Ctrl = ctrl;
                m_Dependencies = deps;
                m_Handler = handler;
        ...
        public void Init(ISwApplication app, IRawDependencyGroup depGroup) {
            m_App = app;
