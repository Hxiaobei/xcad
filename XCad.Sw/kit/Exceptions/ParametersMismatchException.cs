...
namespace XCad.kit.Exceptions {
    ...
    /// <summary>
    /// Exception indicates that the macro feature parameters have not been updated via <see cref="Sw.Features.CustomFeature.Services.IParametersVersionConverter"/>
    /// </summary>
