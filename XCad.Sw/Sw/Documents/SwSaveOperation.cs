...
namespace XCad.Sw.Documents {
    ...
    internal class SwDocument3DSaveOperation : SwSaveOperation, ISwDocument3DSaveOperation {
        ...
        protected override void SetSaveOptions(out object exportData) {
            ...
            if(Bodies?.Any() == true) {
                m_SelGroup.AddRange(Bodies.ToSwArray<ISwBody>().Select(b => b.Body).ToArray());
        ...
        public ISwBody[] Bodies {
            get => m_Creator.CachedProperties.Get<ISwBody[]>();
            set {
                if(!IsCommitted) {
    ...
    internal class SwDrawingSaveOperation : SwSaveOperation, ISwDrawingSaveOperation {
    ...
    internal class SwDocument3DPdfSaveOperation : SwDocument3DSaveOperation, ISwDocument3DPdfSaveOperation {
    ...
    internal class SwDrawingPdfSaveOperation : SwDrawingSaveOperation, ISwDrawingPdfSaveOperation {
