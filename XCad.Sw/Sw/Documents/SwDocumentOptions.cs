...
namespace XCad.Sw.Documents {
    public interface ISwDocumentOptions : IXDocumentOptions {
    }
    ...
    internal class SwViewEntityKindVisibilityOptions : ISwViewEntityKindVisibilityOptions {
        ...
        public bool BendLines {
            get {
                if(m_Doc.OwnerApplication.IsVersionNewerOrEqual(SwVersion_e.Sw2022)) {
    ...
    internal class SwDocumentOptions : ISwDocumentOptions {
