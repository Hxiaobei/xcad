...
namespace XCad.Sw.Sketch {
    public interface ISwSketchEntity : ISwSelObject, IHasColor, IXTransaction, IHasName, IXWireEntity {
        /// <summary>
        ...
        /// </summary>
        ISwSketchBlockInstance OwnerBlock { get; }
    }
    ...
    internal abstract class SwSketchEntity : SwSelObject, ISwSketchEntity {
        ...
        public virtual ISwSketchBlockInstance OwnerBlock {
            get {
