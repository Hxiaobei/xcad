...
namespace XCad.Sw.UI.PropertyPage {
    ...
    internal class SwPropertyManagerPage<TModel> : ISwPropertyManagerPage<TModel>, IAutoDisposable {
        ...
        public void Dispose() {
            if(!m_IsDisposed) {
                m_Logger.Log("Disposing page", LoggerMessageSeverity_e.Debug);
        ...
        public void Show(TModel model) {
            Model = model;
            m_Logger.Log("Opening page", LoggerMessageSeverity_e.Debug);
