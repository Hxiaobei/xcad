...
namespace XCad.Sw.Features {
    ...
    public interface ISwFeature : ISwSelObject, ISwEntity, IHasColor, IDimensionable, IXTransaction, IHasName, ISupportsResilience<ISwFeature> {
    ...
    internal class SwFeatureEntityRepository : SwEntityRepository {
        ...
        protected override IEnumerable<ISwEntity> IterateEntities(bool faces, bool edges, bool vertices, bool silhouetteEdges) {
            if(faces) {
                var featFaces = m_Feat.Feature.GetFaces().ToSwArray<IFace2>();
    ...
    internal class SwFeature : SwSelObject, ISwFeature {
        ...
        ISwBody ISwEntity.Body => Body;
        ISwEntityRepository ISwEntity.AdjacentEntities => AdjacentEntities;
        ISwEntity ISupportsResilience<ISwEntity>.CreateResilient() => CreateResilient();
        ISwComponent ISwEntity.Component => Component;
        ...
        public ISwComponent Component {
            get {
                var comp = ((IEntity)Feature).IGetComponent2();
        ...
        public virtual ISwBody Body {
            get {
                var bodies = AdjacentEntities.ToSwArray<ISwEntity>().Select(e => e.Body).Distinct(new XObjectEqualityComparer<ISwBody>()).ToArray();
        ...
        public virtual IEditor<ISwFeature> Edit() => throw new NotSupportedException();
