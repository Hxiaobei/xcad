...
namespace XCad.Sw.Features.CustomFeature.Attributes {
    ...
    /// Edit bodies will be acquire by macro feature and replaced by the <see cref="Structures.RebuildResult"/>
    /// returned from <see cref="ISwMacroFeatureDefinition.OnRebuild(ISwApplication, Documents.ISwDocument, ISwMacroFeature)"/>.
    /// Multiple bodies are supported
    /// </summary>
    /// <remarks>Supported property type is ISwBody
